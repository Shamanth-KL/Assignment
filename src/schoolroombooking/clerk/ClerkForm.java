...
public class ClerkForm extends JFrame {
    ...
    public ClerkForm() {
        ...
        JLabel lblAddLibrarian = new JLabel("Add Clerks");
        ...
        JButton btnNewButton = new JButton("Add Clerks");
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(i>0){
                    JOptionPane.showMessageDialog(ClerkForm.this,"Clerk added successfully!");
                    ManagerSuccess.main(new String[]{});
                    frame.dispose();

                }else{
                    JOptionPane.showMessageDialog(ClerkForm.this,"Sorry, unable to save!");
                }
            }
        });
